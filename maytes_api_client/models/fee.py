...
class Fee(BaseModel):
    ...
    Fee
    """ # noqa: E501
    gross: Annotated[int, Field(strict=True, ge=0)]
    discount: Annotated[int, Field(strict=True, ge=0)]
    net: Annotated[int, Field(strict=True, ge=0)]
    breakdown: List[FeeBreakdownLine]
    __properties: ClassVar[List[str]] = ["gross", "discount", "net", "breakdown"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "net": obj.get("net"),
            "breakdown": [FeeBreakdownLine.from_dict(_item) for _item in obj["breakdown"]] if obj.get("breakdown") is not None else None
        })
        return _obj
