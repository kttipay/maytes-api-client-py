...
class OAuthTokenRequest(BaseModel):
    ...
    OAuthTokenRequest
    """ # noqa: E501
    grant_type: Annotated[str, Field(min_length=1, strict=True)]
    client_id: UUID
    ...
    __properties: ClassVar[List[str]] = ["grant_type", "client_id", "client_secret", "username", "password", "refresh_token", "scope"]
